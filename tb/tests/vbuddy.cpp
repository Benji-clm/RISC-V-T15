/*!
 \file    vbuddy.cpp
 \brief   additional C++ code included in DUT testbench file to communicate
with Vbuddy \author  Peter Cheung, Imperial College London \version 1.4 \date
28 Oct 2022

This package is written to support a second year module on Electronics &
Information Engineering (EIE) at Imperial College. The module is on the design
of the RISC V CPU.
*/
...
// Import serial communication functions originally by Philippe Lucidarme
// (v2.0) Modify by Peter Cheung to reduce those functions that are not
// required by Vbuddy
...
/*!
  ...
  */
char
serialib::openDevice (const char *Device, const unsigned int Bauds,
...
/*!
  ...
  */
char
serialib::writeChar (const char Byte)
{
#if defined(_WIN32) || defined(_WIN64)
...
/*!
  ...
  */
char
serialib::writeBytes (const void *Buffer, const unsigned int NbBytes)
{
#if defined(_WIN32) || defined(_WIN64)
  // Number of bytes written
  DWORD dwBytesWritten;
...
/*!
  ...
  */
char
serialib::readChar (char *pByte, unsigned int timeOut_ms)
{
#if defined(_WIN32) || defined(_WIN64)
...
/*!
  ...
  */
int
serialib::readStringNoTimeOut (char *receivedString, char finalChar,
                               unsigned int maxNbBytes)
{
...
/*!
  ...
  */
int
serialib::readString (char *receivedString, char finalChar,
...
/*!
   ...
   allows CPU to perform other tasks \return >=0 return the number of bytes
   read before timeout or requested data is completed \return -1 error while
   setting the Timeout \return -2 error while reading the byte
  */
int
serialib::readBytes (void *buffer, unsigned int maxNbBytes,
